...
class AuthManager {
    ...
    public function register($username, $email, $password, $confirmPassword) {
        ...
        try {
            ...
            $this->logActivity($this->pdo->lastInsertId(), 'register', 'Inscription réussie');
            
            $this->sendJsonResponse(true, 'Compte créé avec succès');
    ...
    public function login($emailOrUsername, $password, $remember = false) {
        ...
        if (!$user['is_active']) {
            $this->sendJsonResponse(false, 'Votre compte a été désactivé. Contactez l\'administrateur.');
        }
